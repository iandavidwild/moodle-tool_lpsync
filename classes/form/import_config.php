...
class import_config extends moodleform {
    ...
    public function definition() {
        ...
        $mform->setType('user', PARAM_ALPHANUM);
        ...
        $mform->setType('pass', PARAM_RAW);
        $mform->addRule('pass', null, 'required');
        ...
        $mform->setType('table', PARAM_ALPHANUM);
        ...
        $mform->setType('parentidnumber', PARAM_ALPHANUM);
        ...
        $mform->setType('description', PARAM_ALPHANUM);
        ...
        $mform->setType('descriptionformat', PARAM_ALPHANUM);
        ...
        $mform->setType('scalevalues', PARAM_ALPHANUM);
        ...
        $mform->setType('scaleconfiguration', PARAM_ALPHANUM);
        ...
        $mform->setType('ruletype', PARAM_ALPHANUM);
        ...
        $mform->setType('ruleoutcome', PARAM_ALPHANUM);
        ...
        $mform->setType('ruleconfig', PARAM_ALPHANUM);
        ...
        $mform->setType('relatedidnumbers', PARAM_ALPHANUM);
        $mform->addRule('relatedidnumbers', null, 'required');
        ...
        $mform->setType('isframework', PARAM_ALPHANUM);
        ...
        $mform->setType('taxonomy', PARAM_ALPHANUM);
